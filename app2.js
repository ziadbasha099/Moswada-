...
let links = [
  { id:1, url:'https://www.youtube.com/watch?v=dQw4w9WgXcQ', title:'Design systems in 10 minutes', folder:'coding', tags:['design','tutorial'], notes:'Good refresher on token naming before the redesign. Revisit the elevation section.', type:'video', domain:'youtube.com' },
  ...
  { id:4, url:'https://www.youtube.com/watch?v=jNQXAC9IVRw', title:'Why CSS grid finally clicked for me', folder:'coding', tags:['css','frontend'], notes:'The subgrid explanation at 4:30 is the clearest I\'ve seen.', type:'video', domain:'youtube.com' },
...
function openPlayerModal(l){
  ...
  if(vid){
    wrap.innerHTML = `<iframe src="https://www.youtube-nocookie.com/embed/${vid}?rel=0&modestbranding=1" title="${escapeAttr(l.title)}" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
  } else {
